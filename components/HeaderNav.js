...
export default function Header() {
  ...
  return (
    <nav className="flex flex-col items-center justify-between w-full mt-8 mb-4 text-base leading-5 sm:flex-row">
      ...
      {showNav && (
        <nav className="flex flex-col flex-wrap w-full py-1 font-serif text-2xl font-bold text-center rounded xl:left-[-1.25rem] sm:left-[-0.25rem] relative sm:text-xl sm:mb-8 sm:flex-row sm:hidden">
